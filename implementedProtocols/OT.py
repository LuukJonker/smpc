...
class OT(AbstractProtocol):
    ...
    def protocol_definition(self):
        ...
        self.add_comment("Receiver calculates v")
        ...
        self.add_comment("Sender calculates the encryption of m0 and m1")
        ...
        self.add_comment("Receiver decrypts either m0 or m1.")
